...
const PromoSupport = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Promo Support'));
    }, []);

    const [items, setItems] = useState(supportsData);
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-5">
                <h5 className="font-semibold text-lg dark:text-white-light">Promo Support</h5>
            </div>
            <div className="mb-5">
