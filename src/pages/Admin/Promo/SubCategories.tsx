...
const SubCategories = () => {
    ...
    const [items, setItems] = useState(subcategoriesData);
    ...
    useEffect(() => {
        setInitialRecords(() => {
            return items.filter((item) => {
                return item.categoryName.toLowerCase().includes(search.toLowerCase()) || item.status.tooltip.toLowerCase().includes(search.toLowerCase());
            });
        });
    }, [search]);
                ...
                <div className="invoice-table">
                    <div className="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                        <div className="flex items-center gap-2">
                            ...
                            <Link to="/promo/categories/add" className="btn btn-primary gap-2">
                                <IconPlus />
                                Add New
                            </Link>
                        </div>
                                ...
                                },
                                {
                                    ...
                                    render: ({ id }) => (
                                        <div className="flex gap-4 items-center w-max mx-auto">
                                            <NavLink to="/promo/categories/edit" className="flex hover:text-info">
