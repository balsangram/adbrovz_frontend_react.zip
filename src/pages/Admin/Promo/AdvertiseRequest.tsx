...
import { advertiseRequestsData } from '../../../data';
...
const AdvertiseRequest = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Advertise Requests'));
    }, []);

    const [items, setItems] = useState(advertiseRequestsData);
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-5">
                <h5 className="font-semibold text-lg dark:text-white-light">User Advertise Requests</h5>
            </div>
            <div className="mb-5">
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        render: ({ id }) => (
                                                            <div className="flex gap-4 items-center w-max mx-auto">
                                                                <NavLink to="/promo/advertise-requests/edit" className="flex hover:text-info">
