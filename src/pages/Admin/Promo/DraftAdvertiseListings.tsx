...
import { draftAdvertiseListingsData } from '../../../data';

const DraftAdvertiseListings = () => {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Draft Advertise Listing'));
    }, []);

    const [items, setItems] = useState(draftAdvertiseListingsData);
        ...
        <>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Draft Advertise Listings</span>
                </li>
            </ul>
            <div className="panel px-0 border-white-light dark:border-[#1b2e4b]">
                <div className="flex items-center justify-between ms-4 mb-3">
                    <h5 className="font-semibold text-lg dark:text-white-light">Draft Advertise Listings</h5>
                </div>
...
export default DraftAdvertiseListings;
