...
import { promoDisclaimersData } from '../../../data';
...
const PromoDisclaimer = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Promo Disclaimer'));
    }, []);

    const [items, setItems] = useState(promoDisclaimersData);
        ...
        <>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Promo Disclaimer</span>
                </li>
            </ul>
            <div className="flex items-center justify-between mb-5">
                <h5 className="font-semibold text-lg dark:text-white-light">Promo Disclaimer</h5>
            </div>
            <div className="mb-5">
