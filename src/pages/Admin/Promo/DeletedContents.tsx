...
const DeletedContents = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Deleted Contents'));
    }, []);

    const [items, setItems] = useState(contentsData);
        ...
        <>
            ...
            <div className="panel px-0 border-white-light dark:border-[#1b2e4b]">
                <div className="flex items-center justify-between ms-4 mb-3">
                    <h5 className="font-semibold text-lg dark:text-white-light">Deleted Contents</h5>
                </div>
